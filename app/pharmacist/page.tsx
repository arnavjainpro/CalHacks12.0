        ...
        <header className="sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/80 backdrop-blur-md shadow-sm">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex justify-between items-center">
              <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-purple-500 rounded-lg" aria-label="Go to home">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 sm:p-12 text-center">
              ...
              <p className="text-gray-600 text-lg mb-6">Please connect your wallet to access the pharmacist dashboard.</p>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg text-sm text-purple-800 dark:text-purple-200">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 sm:p-12 text-center" role="status" aria-live="polite">
              ...
              <p className="text-gray-600 text-lg font-medium">Verifying your pharmacist credentials...</p>
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-red-200 p-8 sm:p-12 text-center">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl font-medium"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  <span className="font-semibold text-purple-600">{credential.specialty}</span> Pharmacy
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-10">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-700 p-6 group">
              ...
              <div className="text-sm font-medium text-gray-600 mb-2">Total Dispensals</div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-700 p-6 group">
              ...
              <div className="text-sm font-medium text-gray-600 mb-2">Credential Status</div>
            ...
            <div className="p-6">
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <Link
                  ...
                  className="group flex items-center gap-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-300"
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-lg mb-1">Scan & Dispense</div>
                    <div className="text-purple-100 text-sm">Verify and fulfill prescriptions</div>
                  </div>
                ...
                <Link
                  href="/pharmacist/lookup"
                  className="group flex items-center gap-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-6 rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300"
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-lg mb-1">Lookup Patient</div>
                    <div className="text-blue-100 text-sm">View prescription history</div>
                  </div>
                  <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <div className="p-6">
              {dispensalsLoading ? (
                <div className="flex flex-col items-center justify-center py-16" role="status" aria-live="polite">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center mb-4 animate-pulse">
                    <svg className="w-8 h-8 text-white animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                  </div>
                  <p className="text-gray-600 font-medium">Loading dispensal history...</p>
                </div>
                ...
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">No Dispensals Yet</h3>
                  <p className="text-gray-600 mb-6">You haven&apos;t dispensed any prescriptions yet. Start by scanning your first prescription QR code.</p>
                  <Link
                    href="/pharmacist/dispense"
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl font-medium"
                  >
