      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">You need a valid Doctor credential to view prescriptions.</p>
            {!isConnected && (
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            <div className="animate-pulse">
              <div className="text-4xl mb-4">📄</div>
              <h2 className="text-2xl font-bold mb-2 dark:text-gray-100">Loading Prescription...</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-4xl font-bold dark:text-gray-100">Prescription #{prescriptionId?.toString()}</h1>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-6">
            <div>
              <h2 className="text-2xl font-bold mb-4 dark:text-gray-100">Prescription Information</h2>

              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">Patient Data Hash</h3>
                  <p className="font-mono text-sm break-all bg-gray-50 dark:bg-gray-700 dark:text-gray-200 p-3 rounded">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg space-y-2">
                    ...
                    <div className="space-y-2 text-sm">
                      <div>
                        ...
                        <p className="font-mono text-xs break-all mt-1 dark:text-gray-400">{metadata.patientName}</p>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-300">Encrypted DOB:</span>
                        <p className="font-mono text-xs break-all mt-1 dark:text-gray-400">{metadata.patientDOB}</p>
                      </div>
                      <div>
                        <span className="text-gray-600 dark:text-gray-300">Encrypted ID:</span>
                        <p className="font-mono text-xs break-all mt-1 dark:text-gray-400">{metadata.patientID}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t dark:border-gray-700 pt-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                      ...
                      <p className="text-xl font-bold text-blue-900 dark:text-blue-300">{metadata.medication}</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Dosage</p>
                        <p className="font-semibold dark:text-gray-200">{metadata.dosage}</p>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Quantity</p>
                        <p className="font-semibold dark:text-gray-200">{metadata.quantity}</p>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Refills</p>
                        <p className="font-semibold dark:text-gray-200">{metadata.refills}</p>
                      </div>
                    </div>
            ...
            <div className="border-t dark:border-gray-700 pt-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                ...
                <p className="font-mono text-sm break-all dark:text-gray-200">{prescription.ipfsCid}</p>
                <a
            ...
            <div className="border-t dark:border-gray-700 pt-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-medium ${isExpired ? 'text-red-600 dark:text-red-400' : 'dark:text-gray-200'}`}>
            ...
            {prescription.status === PrescriptionStatus.Dispensed && prescription.pharmacistTokenId > 0n && (
              <div className="border-t dark:border-gray-700 pt-6">
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-300">Dispensed by Pharmacist Token ID:</p>
                  <p className="font-mono text-lg font-bold text-green-800 dark:text-green-300">
            ...
            <div className="border-t dark:border-gray-700 pt-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono dark:text-gray-200">#{prescription.doctorTokenId.toString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-300">Prescription ID:</span>
                  <span className="font-mono dark:text-gray-200">#{prescription.prescriptionId.toString()}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {prescription.status === PrescriptionStatus.Active && !isExpired && (
            <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              <h3 className="font-semibold mb-4 dark:text-gray-100">Actions</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                This prescription is active and can be dispensed by a pharmacist. Download or email the prescription PDF to the patient.
              </p>
